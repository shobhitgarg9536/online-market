    ...
    <div class="row" ng-init="pCtrl.fetchProducts()">
        ...
        <div class="col-md-9">
            ...
            <div class="row is-table-row">
                ...
                <div class="col-sm-4" ng-repeat="product in pCtrl.mvProducts track by product.id">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            ...
                            <a ng-href="${base}/show/{{product.id}}/product" class="btn btn-primary pull-right">View</a>
                        </div>
                    </div>
                ...
                <div class="col-sm-4 col-lg-4 col-md-4">
                    ...
                    <hr/>
                    <a class="btn btn-primary" href="${base}/show/all/products">More Products</a>
                </div>
            ...
            <div class="row is-table-row">
                ...
                <div class="col-sm-4" ng-repeat="product in pCtrl.mpProducts track by product.id">
                    <div class="thumbnail">
                        <img ng-src="${images}/{{product.code}}.jpg" alt="{{product.name}}" class="landingImg"
                             style="width: 100px; height: 100px">
                        <h5>{{product.name}}</h5>
