    ...
    <div class="row">
        ...
        <div class="offset-md-2 col-md-8">
            ...
            <div class="card ">
                ...
                <div class="card-body">
                    <sf:form class="form-horizontal" modelAttribute="product" action="${base}/manage/product" method="POST"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <sf:form id="categoryForm" class="form-horizontal" modelAttribute="category" action="${base}/manage/category" method="POST">
